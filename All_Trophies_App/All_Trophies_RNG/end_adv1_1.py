    ...
    while True:
        ...
        if cat_roll:
            ...
            if success_roll < 60:  # sometimes this is 65, not sure what the cause for this is though.
                ...
                trophy_stage_roll = ((len(trophies)) * ((
                                                                    -1422735383 * temp_seed + 2234209426) & 4294967295) >> 16) >> 16  # sometimes this is done out of 88?
...
def main(owned_trophies):
    ...
    while len(trophies) > 0:
        ...
        for b in buckets:
            if trophy_name in b:
                for t in b:
                    if t != trophy_name and t in trophies:
